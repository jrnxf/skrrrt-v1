...
const Privacy = () => {
  return (
    <>
      <Head>
        <title>skrrrt | privacy policy</title>
      </Head>
      <div className="mx-auto mb-4 text-lg max-w-7xl">
        ...
        when you visit or make a purchase from https://skrrrt.io (the “Site”).
        <p className="mt-2 mb-1 font-extrabold">PERSONAL INFORMATION WE COLLECT</p>
        ...
        Device Information using the following technologies: - “Cookies” are data files that are
        placed on your device or computer and often include an anonymous unique identifier. For more
        ...
        stamps. - “Web beacons,” “tags,” and “pixels” are electronic files used to record
        information about how you browse the Site. Additionally when you make a purchase or attempt
        to make a purchase through the Site, we collect certain information from you, including your
        name, billing address, shipping address, payment information (including credit card numbers
        and PayPal), email address, and phone number. We refer to this information as “Order
        Information.” When we talk about “Personal Information” in this Privacy Policy, we are
        talking both about Device Information and Order Information.
        <p className="mt-2 mb-1 font-extrabold">HOW DO WE USE YOUR PERSONAL INFORMATION?</p>
        ...
        <p className="mt-2 mb-1 font-extrabold">SHARING YOUR PERSONAL INFORMATION</p>
        ...
        Google Analytics here: https://tools.google.com/dlpage/gaoptout. Finally, we may also share
        your Personal Information to comply with applicable laws and regulations, to respond to a
        subpoena, search warrant or other lawful request for information we receive, or to otherwise
        protect our rights. Additionally, you can opt out of some of these services by visiting the
        Digital Advertising Alliance’s opt-out portal at: http://optout.aboutads.info/.
        <p className="mt-2 mb-1 font-extrabold">DO NOT TRACK</p>
        ...
        <p className="mt-2 mb-1 font-extrabold">YOUR RIGHTS</p>
        ...
        <p className="mt-2 mb-1 font-extrabold">DATA RETENTION</p>
