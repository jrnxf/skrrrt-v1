...
const Terms = () => {
  return (
    <>
      <Head>
        <title>skrrrt | terms of service</title>
      </Head>
      <div className="mx-auto mb-4 text-lg max-w-7xl">
        <div className="flex flex-col items-center">
          <div className="page-title">Terms of Service</div>
          <div className="mb-4 font-semibold text-secondary">Updated January 17, 2021</div>
        </div>
        <p className="mb-1 font-extrabold">Overview</p>
        This website is operated by skrrrt. Throughout the site, the terms “we”, “us” and “our”
        refer to skrrrt. skrrrt offers this website, including all information, tools and services
        ...
        something from us, you engage in our “Service” and agree to be bound by the following terms
        ...
        vendors, customers, merchants, and/ or contributors of content. Please read these Terms of
        Service carefully before accessing or using our website. By accessing or using any part of
        the site, you agree to be bound by these Terms of Service. If you do not agree to all the
        terms and conditions of this agreement, then you may not access the website or use any
        services. If these Terms of Service are considered an offer, acceptance is expressly limited
        to these Terms of Service. Any new features or tools which are added to the current store
        shall also be subject to the Terms of Service. You can review the most current version of
        the Terms of Service at any time on this page. We reserve the right to update, change or
        replace any part of these Terms of Service by posting updates and/or changes to our website.
        It is your responsibility to check this page periodically for changes. Your continued use of
        or access to the website following the posting of any changes constitutes acceptance of
        those changes. Our store is hosted on Shopify Inc. They provide us with the online
        e-commerce platform that allows us to sell our products and services to you.
        <p className="mt-2 mb-1 font-extrabold">SECTION 1 - ONLINE STORE TERMS</p>
        ...
        (including but not limited to copyright laws). You must not transmit any worms or viruses or
        any code of a destructive nature. A breach or violation of any of the Terms will result in
        an immediate termination of your Services.
        <p className="mt-2 mb-1 font-extrabold">SECTION 2 - GENERAL CONDITIONS</p>
        We reserve the right to refuse service to anyone for any reason at any time. You understand
        that your content (not including credit card information), may be transferred unencrypted
        ...
        encrypted during transfer over networks. You agree not to reproduce, duplicate, copy, sell,
        resell or exploit any portion of the Service, use of the Service, or access to the Service
        or any contact on the website through which the service is provided, without express written
        permission by us. The headings used in this agreement are included for convenience only and
        will not limit or otherwise affect these Terms.
        <p className="mt-2 mb-1 font-extrabold">
        ...
        the material on this site is at your own risk. This site may contain certain historical
        information. Historical information, necessarily, is not current and is provided for your
        ...
        time to modify or discontinue the Service (or any part or content thereof) without notice at
        any time. We shall not be liable to you or to any third-party for any modification, price
        change, suspension or discontinuance of the Service.
        <p className="mt-2 mb-1 font-extrabold">SECTION 5 - PRODUCTS OR SERVICES (if applicable)</p>
        ...
        according to our Return Policy. We have made every effort to display as accurately as
        possible the colors and images of our products that appear at the store. We cannot guarantee
        that your computer monitor's display of any color will be accurate. We reserve the right,
        but are not obligated, to limit the sales of our products or Services to any person,
        ...
        Any offer for any product or service made on this site is void where prohibited. We do not
        warrant that the quality of any products, services, information, or other material purchased
        ...
        promptly update your account and other information, including your email address and credit
        card numbers and expiration dates, so that we can complete your transactions and contact you
        as needed. For more detail, please review our Returns Policy.
        <p className="mt-2 mb-1 font-extrabold">SECTION 7 - OPTIONAL TOOLS</p>
        ...
        is” and “as available” without any warranties, representations or conditions of any kind and
        without any endorsement. We shall have no liability whatsoever arising from or relating to
        your use of optional third-party tools. Any use by you of optional tools offered through the
        site is entirely at your own risk and discretion and you should ensure that you are familiar
        with and approve of the terms on which tools are provided by the relevant third-party
        ...
        <p className="mt-2 mb-1 font-extrabold">SECTION 8 - THIRD-PARTY LINKS</p>
        ...
        that your comments will not contain libelous or otherwise unlawful, abusive or obscene
        ...
        or any third-party.
        <p className="mt-2 mb-1 font-extrabold">SECTION 10 - PERSONAL INFORMATION</p>
        Your submission of personal information through the store is governed by our Privacy Policy.
        To view our Privacy Policy.
        <p className="mt-2 mb-1 font-extrabold">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</p>
        ...
        <p className="mt-2 mb-1 font-extrabold">SECTION 12 - PROHIBITED USES</p>
        ...
        and non-infringement. In no case shall skrrrt, our directors, officers, employees,
        ...
        <p className="mt-2 mb-1 font-extrabold">SECTION 14 - INDEMNIFICATION</p>
        You agree to indemnify, defend and hold harmless skrrrt and our parent, subsidiaries,
        ...
        <p className="mt-2 mb-1 font-extrabold">SECTION 15 - SEVERABILITY</p>
        ...
        <p className="mt-2 mb-1 font-extrabold">SECTION 16 - TERMINATION</p>
        ...
        effective unless and until terminated by either you or us. You may terminate these Terms of
        Service at any time by notifying us that you no longer wish to use our Services, or when you
        cease using our site. If in our sole judgment you fail, or we suspect that you have failed,
        to comply with any term or provision of these Terms of Service, we also may terminate this
        agreement at any time without notice and you will remain liable for all amounts due up to
        and including the date of termination; and/or accordingly may deny you access to our
        Services (or any part thereof).
        <p className="mt-2 mb-1 font-extrabold">SECTION 17 - ENTIRE AGREEMENT</p>
        ...
        <p className="mt-2 mb-1 font-extrabold">SECTION 18 - GOVERNING LAW</p>
        ...
        reserve the right, at our sole discretion, to update, change or replace any part of these
        ...
        <p className="mt-2 mb-1 font-extrabold">SECTION 20 - CONTACT INFORMATION</p>
        Questions about the Terms of Service should be sent to us at colby@skrrrt.io.
      </div>
    </>
  )
}
