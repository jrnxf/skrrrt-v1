...
var defaultConfig = {
  fromEmail: 'colby@skrrrt.io',
  subjectPrefix: '(skrrrt) ',
  emailBucket: 'skrrrt',
  ...
  forwardMapping: {
     ...
     *
     * 1.  @skrrrt.io will catch all email send to the domain and forward it
     *     to the array of emails listed
     *
     * 2.  The email sent to xxxxxx@skrrrt.io will physically landed in the email
     ...
     *     can then choose to send email with their personal xxxxx@skrrrt.io email
     **/
    '@skrrrt.io': [
      // catch all
